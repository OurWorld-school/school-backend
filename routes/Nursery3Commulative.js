const Nursery3Commulative = require("../models/Nursery3Commulative");
...
router.post("/", async (req, res) => {
  ...
  try {
    const ResultAlreadyExits = await Nursery3Commulative.findOne({
      year,
      term,
      classes,
      user,
    ...
    await User.findByIdAndUpdate(userId, {
      $push: { nursery3commulative: newResult._id },
    });
